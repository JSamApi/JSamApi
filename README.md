# Привет! Меня зовут Семён 👋, я начинающий QA Engineer.

Последние полгода я с головой ушел в тестирование и сейчас ищу свою первую команду. Я из тех людей, кому искренне в кайф находить баги и разбираться, как всё устроено изнутри.

### 🛠 Чем я занимаюсь:
* **Тестовые артефакты:** Умею быстро набросать четкий чек-лист. Пишу такие тест-кейсы и баг-репорты, по которым разработчикам всё понятно, а главное - приятно работать. Все найденные баги бережно оформляю в **Яндекс Трекере** и запускаю в работу.
* **Фронтенд:** Плотно дружу с **DevTools** - он покрывает 90% моих задач. С ним я наблюдаю за "общением" сервисов в **Network**, ловлю ошибки в консоли и разбираю "скелет" и CSS через **Elements**. Главное, чтобы фронт не просто работал, а выглядел именно так, как задумано.
* **Работа с API:** Обожаю составлять и отправлять запросы в **Postman**. Postman - это вообще база! Когда открываю его, реально чувствую себя немного хакером: сижу, «дергаю» ручки и смотрю, что там под капотом у сервисов.
* **SQL:** Пока я не гуру запросов, но это направление вызывает у меня азарт. Составлять даже простые `SELECT`-ы и видеть результат - это кайф!

### 🎯 Мои цели:
Хочу попасть в крутую команду с реальными задачами. Мой план - быстро впитать опыт коллег, поднять грейд и стать спецом, на которого можно положиться.
...
![](https://github-readme-stats.vercel.app/api?hide_rank=true&hide=issues,contribs&show_icons=true&locale=en&langs_count=8&card_width=320&username=JSamApi)
![](https://github-readme-stats.vercel.app/api/top-langs/?layout=donut&langs_count=6&hide_progress=true&username=JSamApi)

<!-- Выбор темы ↑↑: https://github.com/anuraghazra/github-readme-stats/blob/master/themes/README.md --> 
<!-- Настройка отображения ↑↑: https://github.com/anuraghazra/github-readme-stats/ --> 

![](https://github-readme-activity-graph.vercel.app/graph?&theme=minimal&username=JSamApi)
...
<div>
  <img src="https://raw.githubusercontent.com/JSamApi/JSamApi/refs/heads/main/screenshots/chrome_devtools_browser_logo_icon_153005.png" title="DevToos" alt="DevToos" width="40" height="40"/>&nbsp
...
<div>
  ...
  <img src="https://raw.githubusercontent.com/wiki/dbeaver/dbeaver/images/dbeaver-head.png" title="DBeaver" alt="DBeaver" width="40" height="40"/>&nbsp
</div>
...
[<img src="screenshots/0327626683b.png" width="280px" hspace="10px" alt="Диплом»">](https://raw.githubusercontent.com/JSamApi/JSamApi/refs/heads/main/screenshots/0327626683b.png)
