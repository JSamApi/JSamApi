...
* **Работа с API:** Обожаю составлять и отправлять запросы в **Postman**. Это база! Когда открываю его, реально чувствую себя немного хакером: сижу, «дергаю» ручки и смотрю, что там под капотом у сервисов.
* **SQL (in progress):** Пока я не гуру запросов, но это направление вызывает у меня азарт. Составлять даже простые `SELECT`-ы и видеть результат — это кайф!
