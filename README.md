...
### 🛠 Чем я занимаюсь:
* **Как тестировщик:** Пишу такие тест-кейсы и баг-репорты, по которым разработчикам понятно, а главное приятно работать.
...
* **SQL (в процессе):** Пока я не гуру запросов, но это направление вызывает у меня азарт. Составлять даже простые `SELECT`-ы и видеть результат — это кайф!
...
### 📫 Связаться со мной:
* **Telegram:** [@SamAugustov](https://t.me)
* **Email:** [hardsam4@mail.com](mailto:твой_email@mail.com)
